...
export default function UrgentDonationsPage() {
  ...
  const fetchHospitalRequests = async () => {
    setLoading(true);
    try {
      // Query urgent and open requests only
        ...
        <DialogContent className="max-w-md md:max-w-lg lg:max-w-xl">
          ...
          <DialogHeader className="flex flex-col md:flex-row items-start md:items-center gap-4 pt-2">
            ...
            <div className="space-y-1">
              ...
              <Badge variant="destructive" className="mt-1">Urgent Blood Request</Badge>
            </div>
          </DialogHeader>
      ...
      <ContentLayout title="Urgent Donation Requests">
        <div className="w-full">
          <div className="max-w-6xl px-4 py-6">
            <h1 className="text-3xl font-bold text-red-500 mb-4">🚨 Urgent Blood Requests from Hospitals</h1>
            <p className="text-md text-gray-700 dark:text-gray-300 mb-3">
              <span className="text-red-500">Lives are at risk.</span> <span className="font-semibold">Urgent blood donations</span> are needed at the hospitals listed below. Your donation can be the difference between life and death.
            </p>
            <p className="text-md text-gray-700 dark:text-gray-300 mb-3">
              <span className="font-semibold">Your blood group: </span>
              <span className="text-red-600 font-bold capitalize">{profile?.d_bloodgroup || "Loading..."}</span>
            </p>
            <p className="text-md text-gray-700 dark:text-gray-300 mb-3">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground">
                No urgent donation requests that match your profile are open right now.
              </p>
            </div>
          )}
        </div>
